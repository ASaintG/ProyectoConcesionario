...
echo '<script>window.location="honda.php"</script>';
}
}
}
}
...
<h3 align="center">Elige tu modelo favorito de Honda</h3>
<?php
$query = "SELECT * FROM productos WHERE name LIKE '%HONDA%' ORDER BY id ASC";
...
<td><a href="honda.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span button type="button" class="btn btn-danger">Eliminar</button</span></a></td>
</tr>
<?php
