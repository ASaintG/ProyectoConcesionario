...
echo '<script>window.location="Toyota.php"</script>';
}
}
}
}
...
<br>
<br>
<h3 align="center">Elige tu modelo favorito de Toyota</h3>
<br>
<?php
$query = "SELECT * FROM productos WHERE name LIKE '%TOYOTA%' ORDER BY id ASC;";
...
<!--Poner la pagina a la que retorna-->
<td><a href="Toyota.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span button type="button" class="btn btn-danger">Eliminar</button</span></a></td>
</tr>
<?php
