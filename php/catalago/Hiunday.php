...
echo '<script>window.location="Hiunday.php"</script>';
}
}
}
}
...
<br>
<br>
<h3 align="center">Elige tu modelo favorito de Hyundai</h3>
<br>
<?php
$query = "SELECT * FROM productos WHERE name LIKE '%Hyundai%' ORDER BY id ASC;";
...
<!--Poner la pagina a la que retorna-->
<td><a href="Hiunday.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span button type="button" class="btn btn-danger">Eliminar</button</span></a></td>
</tr>
<?php
...
<td colspan="3" align="right"></td>   
    <td>
    <button type="button" class="btn btn-primary" onclick="datosCliente">Procesar factura</button> 
    </td>
    </tr>
<?php
}
